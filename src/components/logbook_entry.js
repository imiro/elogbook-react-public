      ...
      <div className="container-dashboard">
	    ...
	    <form ref={form}>
            <div id="logbook-entry" className="logbook-entry">
                    ...
                    <label>Stase</label>
                    <Select placeholder="Pilih stase" options={optionStase} isSearchable={isSearchable} className="logbook-entry-select" name="stase" value={optionStase.filter(x => x.value == inputValues.stase)} onChange={handleInputChange("stase")} styles={colourStyles} />
                    <label>Lokasi Rumah Sakit</label>
                    <Select placeholder="Pilih lokasi rumah sakit"options={optionRS} name="wahana" className="logbook-entry-select" value={optionRS.filter(x => x.value == inputValues.wahana)} onChange={handleInputChange("wahana")} styles={colourStyles}/>
                    <label>Ruangan</label>
                    <Select placeholder="Pilih ruangan"options={optionRoom} name="lokasi" className="logbook-entry-select" value={optionRoom.filter(x => x.value == inputValues.lokasi)} onChange={handleInputChange("lokasi")} styles={colourStyles} />
                    <label>NRM</label>
                    ...
                    <Select placeholder="Pilih jenis kelamin" name="gender" options={optionGender} className="logbook-entry-select" value={optionGender.filter(x => x.value == inputValues.gender)} onChange={handleInputChange("gender")} styles={colourStyles}/>
                    <label>Usia</label>
                    <div className="logbook-entry-age">
                      ...
                      <Select placeholder="Pilih waktu" name="satuanusia" options={optionTime} id="idTime" className="logbook-entry-select" value={optionTime.filter(x => x.value == inputValues.satuanusia)} onChange={handleInputChange("satuanusia")} styles={colourStyles}/>
                    </div>
                    <label>Diagnosis</label>
                    <CreatableSelect name="dx" placeholder="Pilih diagnosis pasien"options={optionDiagnosis} onChange={handleSkdiChange("dx")} isMulti styles={colourStylesMulti} value={skdi.dx} />
	    ...
	    {/*<label>Jenis Tindakan</label>
                    ...
                    <CreatableSelect  placeholder="Pilih keterampilan"options={optionSkill} isMulti styles={colourStylesMulti} value={skdi.ktn} onChange={handleSkdiChange("ktn")}  />
